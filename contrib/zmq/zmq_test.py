...
"""
    ...
    Raptoreum should be started with the command line arguments:
...
print("Getting Raptoreumcoin msgs")
...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND RTM issuance at " + str(pos))
				print("After RTM: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND RTM something at " + str(pos))
			start += pos+8
			print(astr)
