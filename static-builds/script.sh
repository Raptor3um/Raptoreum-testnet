...
rm -rf ~/raptoreumcoin ~/sign ~/release
...
find ${DISTNAME}/bin -type f -executable -exec ../raptoreumcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../raptoreumcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/raptoreumcoin/temp
cd ~/raptoreumcoin/temp
tar xf ../$SOURCEDIST
...
mkdir -p ~/raptoreumcoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/raptoreumcoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
