...
Run with the -testnet option to run with "play raptoreums" on the test network, if you
...
Raptoreum Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- RaptoreumMiner : Generates raptoreums (if wallet is enabled).
...
Some of these are maintained by active developers of Raptoreum Core, in which case changes should probably go
...
- src/libsecp256k1
  - Upstream at https://github.com/raptoreum-core/secp256k1/ ; actively maintaned by Core contributors.

- src/crypto/ctaes
  - Upstream at https://github.com/raptoreum-core/ctaes ; actively maintained by Core contributors.
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:raptoreum/raptoreum.git
