Raptoreum Core version *0.15.0.1* is now available from:

  <https://raptoreum.org/bin/raptoreum-core-0.15.0.1/>

and

  <https://raptoreumcoin.org/bin/raptoreum-core-0.15.0.1/>
