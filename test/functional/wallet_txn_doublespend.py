...
class TxnMallTest(RaptoreumTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 RTM:
        ...
        # First: use raw transaction API to send 1240 RTM to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 RTM coin each
        ...
        # Node0's balance should be starting balance, plus 50RTM for another
        ...
        # Node0's total balance should be starting balance, plus 100RTM for 
