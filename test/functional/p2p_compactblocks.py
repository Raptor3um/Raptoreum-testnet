...
# TestNode: A peer we use to send messages to raptoreumd, and store responses.
...
class CompactBlocksTest(RaptoreumTestFramework):
    ...
    # This test actually causes raptoreumd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that raptoreumd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for raptoreumd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # raptoreumd will not send blocktxn responses for blocks whose height is
