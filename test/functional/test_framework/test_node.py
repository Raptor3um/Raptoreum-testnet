...
RAPTOREUMD_PROC_WAIT_TIMEOUT = 60
...
class TestNode():
    ...
    def __init__(self, i, dirname, extra_args, rpchost, timewait, binary, stderr, mocktime, coverage_dir):
        ...
        if timewait:
            ...
            self.rpc_timeout = 60
        if binary is None:
            self.binary = os.getenv("RAPTOREUMD", "raptoreumd")
        else:
            self.binary = binary
        self.stderr = stderr
        ...
        self.cli = TestNodeCLI(os.getenv("RAPTOREUMCLI", "raptoreum-cli"), self.datadir)
    ...
    def wait_until_stopped(self, timeout=RAPTOREUMD_PROC_WAIT_TIMEOUT):
...
class TestNodeCLI():
    ...
    def __call__(self, *args, input=None):
        # TestNodeCLI is callable with raptoreum-cli command-line args
