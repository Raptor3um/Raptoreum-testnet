...
Also test that nodes that send unsupported service bits to raptoreumd are disconnected
and don't receive a VERACK. Unsupported service bits are currently 1 << 5 and
1 << 7 (until August 1st 2018).

UPDATE: Raptoreum RIP-2 uses bit 1 << 5.  Currently there are no unsupported service bits.
"""
...
class P2PLeakTest(RaptoreumTestFramework):
