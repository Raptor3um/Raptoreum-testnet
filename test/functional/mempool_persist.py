...
By default, raptoreumd will dump mempool on shutdown and
...
class MempoolPersistTest(RaptoreumTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent raptoreumd from writing mempool.dat to disk. Verify that `savemempool` fails")
