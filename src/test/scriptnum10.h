...
#ifndef RAPTOREUM_TEST_SCRIPTNUM10_H
#define RAPTOREUM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Raptoreum Core 0.10.0, for cross-comparison.
 */
public:
