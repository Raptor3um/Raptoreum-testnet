...
#ifndef RAPTOREUM_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define RAPTOREUM_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // RAPTOREUM_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
