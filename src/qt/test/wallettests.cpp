...
#include "qt/raptoreumamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<RaptoreumAmountField*>("payAmount")->setValue(amount);
...
void TestGUI()
{
    ...
    QString balanceComparison = RaptoreumUnits::formatWithUnit(unit, balance, false, RaptoreumUnits::separatorAlways);
    ...
    // Amount input
    RaptoreumAmountField* amountInput = receiveCoinsDialog.findChild<RaptoreumAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: raptoreum:")) != -1);
