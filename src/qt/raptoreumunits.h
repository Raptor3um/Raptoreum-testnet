...
#ifndef RAPTOREUM_QT_RAPTOREUMUNITS_H
#define RAPTOREUM_QT_RAPTOREUMUNITS_H
...
*/
class RaptoreumUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit RaptoreumUnits(QObject *parent);

    /** Raptoreum units.
      @note Source: https://en.raptoreum.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        RTM,
...
typedef RaptoreumUnits::Unit RaptoreumUnit;

#endif // RAPTOREUM_QT_RAPTOREUMUNITS_H
